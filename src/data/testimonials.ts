...
export const TESTIMONIALS_DATA: TestimonialItem[] = [
  {
    ...
    quote: 'Being able to see and interact with the Health Clinic demo before making a decision gave our board complete confidence. digitalsimplesolution launched our customized portal in just 6 days, and our patient online booking skyrocketed by 84%.',
    rating: 5,
