    ...
    <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-24">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight font-heading leading-tight">
          Modern Digital Marketing for <br />
        ...
        <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
          High-performance search engine marketing, targeted paid social, automated email funnels, and conversion-optimized websites designed to grow your pipeline.
        </p>
        ...
        <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
          ...
          >
            <span>Book Marketing Strategy Audit</span>
