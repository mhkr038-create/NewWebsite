          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
            <div className="lg:col-span-8 space-y-3 text-left">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="inline-flex items-center gap-1 bg-amber-950 text-amber-200 border border-amber-500/40 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider">
                  <Clock className="w-3 h-3 text-amber-400" />
                  <span>LIMITED PERIOD</span>
                </span>
                <span className="inline-flex items-center gap-1 bg-red-950 text-red-200 border border-red-800/60 px-2 py-0.5 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider">
                  <Flame className="w-3 h-3 text-red-400" />
                  <span>LIMITED TO FIRST 25 SCHOOLS</span>
                </span>
              ...
              <div className="bg-slate-950/70 border border-amber-500/30 rounded-xl p-3 max-w-xl">
                <div className="flex items-center justify-between text-[11px] font-mono mb-1.5">
                  ...
                  <span className="text-emerald-400 font-bold">Only 7 Remaining!</span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-full overflow-hidden">
                  <div className="bg-gradient-to-r from-amber-500 to-red-500 h-full rounded-full w-[72%] transition-all duration-1000" />
                </div>
              </div>
