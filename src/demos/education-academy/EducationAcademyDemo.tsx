...
export const EducationAcademyDemo: React.FC = () => {
  ...
  const courses = [
    ...
    },
    {
      ...
      description: 'Build and ship 4 production SaaS products with Next.js App Router, Tailwind CSS, Supabase authentication, and payment integrations.',
      syllabus: [
        'Week 1-3: Modern React 19 State Machines & Server Components',
        'Week 4-6: Postgres Architecture, Row-Level Security & Webhooks',
        'Week 7-8: Recurring Billing, Subscription Metering & Customer Portals',
    ...
    },
    {
      ...
      description: 'The exact framework used to scale 12 tech startups from ₹0 to ₹10 Crores ARR using paid media, algorithmic SEO, and viral referral loops.',
      syllabus: [
